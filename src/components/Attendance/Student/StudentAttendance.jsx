...
export default function StudentAttendance() {
  ...
  const attendanceData = {
    '2024-05-29': { status: 'A', shift: '09:00 - 17:00', login: 'N/A', netHours: 'N/A' },
    '2024-05-28': { status: 'HW', shift: '09:00 - 17:00', login: '09:05 - 17:12 ', netHours: '7h 55m' },
    '2024-05-27': { status: 'H', shift: '09:00 - 17:00', login: '09:05 - 17:12', netHours: 'N/A' },
    '2024-05-26': { status: 'L', shift: '09:00 - 17:00', login: 'N/A', netHours: 'N/A' },
    '2024-05-25': { status: 'U', shift: '09:00 - 17:00', login: 'N/A', netHours: 'N/A' },
    '2024-05-24': { status: 'P', shift: '09:00 - 17:00', login: '09:05 - 17:12', netHours: '7h 50m' },
    '2024-05-23': { status: 'A', shift: '09:00 - 17:00', login: 'N/A', netHours: 'N/A' },
  };
    ...
    <Box minHeight="100vh" display="flex" flexDirection="column" p={4}>
      <Box mb={5} mt={5}>
        <HStack justifyContent="space-between" mb={4}>
          <Input
            placeholder="Search Student by the Student id and name..."
            width="400px"
            />
          <HStack spacing={2}>
